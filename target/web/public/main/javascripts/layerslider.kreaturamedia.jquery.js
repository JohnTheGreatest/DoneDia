...
*/
			...
			if( ls.o.navPrevNext ){
				...
				$('<div class="nav-wrapper"><div class="container"><a class="ls-nav-prev" href="#" /></div></div>').click(function(e){
					e.preventDefault();
					$(el).layerSlider('prev');
				}).appendTo($('.ls-container'));

				$('<a class="ls-nav-next" href="#" />').click(function(e){
					e.preventDefault();
					$(el).layerSlider('next');
				}).appendTo($('.ls-container .nav-wrapper .container'));					
			}
