@REM diapost launcher script
@REM
@REM Environment:
@REM JAVA_HOME - location of a JDK home dir (optional if java on path)
@REM CFG_OPTS  - JVM options (optional)
@REM Configuration:
@REM DIAPOST_config.txt found in the DIAPOST_HOME.
@setlocal enabledelayedexpansion

@echo off
if "%DIAPOST_HOME%"=="" set "DIAPOST_HOME=%~dp0\\.."
set ERROR_CODE=0

set "APP_LIB_DIR=%DIAPOST_HOME%\lib\"
...
set "CFG_FILE=%DIAPOST_HOME%\DIAPOST_config.txt"
set CFG_OPTS=
if exist %CFG_FILE% (
...
if "%JAVAOK%"=="false" (
  ...
  echo and download a valid Java JDK and install before running diapost.
  echo.
